    ...
    return (
        <div className="popup-container fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="popup-content bg-transparent p-8 rounded-xl shadow-2xl w-96">
                <h2 className="text-3xl font-semibold text-center text-gray-800">Congratulations!</h2>
                <p className="text-lg text-center text-gray-600 mt-2">You have successfully completed the lesson!</p>
                ...
                {/* Close button */}
                {/* If you want to have a close button, you can add it here */}
                {/* <button 
                    onClick={onClose} 
